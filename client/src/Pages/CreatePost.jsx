      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="relative bg-gray-50 border border-gray-300
          ...
          focus:ring-blue-500 focus:border-blue-500
           w-64 p-3 h-64 flex justify-center items-center mt-4">
          {form.photo ? (
            <img
              src={form.photo}
              alt={form.prompt}
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="text-white bg-violet-900 font-medium rounded-md
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#747575] text-[14px]">
            ** Once you have created the image you want, you can share it with others in the community **</p>
          <button
            type="submit"
            className="mt-3 text-white bg-[#0911ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
